...
data = read.csv('Output/datatrimwzeros_2012-03-03.csv', row.names=1)
	dim(data)
...
# make sure the months match
all(datatrim$MONTH == datatrim$month)
...
names(datatrim)[names(datatrim)=='long'] = 'lon' # use the adjusted longitude
